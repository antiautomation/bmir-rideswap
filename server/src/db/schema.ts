...
export const users = pgTable('users', {
  ...
  /** null = use the global minEmailScore setting. */
  matchEmailMinScore: integer('match_email_min_score'),
  matchEmailSameDayOnly: boolean('match_email_same_day_only').notNull().default(false),
